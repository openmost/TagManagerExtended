...
class ConsoleTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/javascript.svg';
    }

    public function getParameters()
    {
        return array(
            $this->makeSetting('consoleType', 'log', FieldConfig::TYPE_ARRAY, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_ConsoleTagTypeTitle');
                $field->description = Piwik::translate('TagManagerExtended_ConsoleTagTypeDescription');
            ...
            $this->makeSetting('content', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_ConsoleTagContentTitle');
                $field->description = Piwik::translate('TagManagerExtended_ConsoleTagContentDescription');
