...
class MicrosoftClarityTag extends BaseTag
{
    ...
    public function getParameters()
    {
        return array(
            $this->makeSetting('projectId', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_MicrosoftClarityProjectId');
                $field->description = Piwik::translate('TagManagerExtended_MicrosoftClarityProjectIdDescription');
