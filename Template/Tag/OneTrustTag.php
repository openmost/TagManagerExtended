...
class OneTrustTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/one-trust.svg';
    }
    ...
    public function getParameters()
    {
        return array(
            $this->makeSetting('domain', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_OneTrustTagDomainTitle');
                $field->description = Piwik::translate('TagManagerExtended_OneTrustTagDomainDescription');
