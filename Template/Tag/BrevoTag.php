...
class BrevoTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/brevo.svg';
    }

    public function getParameters()
    {
        return array(
            $this->makeSetting('brevoClientKey', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_BrevoTagClientKeyTitle');
                $field->description = Piwik::translate('TagManagerExtended_BrevoTagClientKeyDescription');
