...
class GoogleAdsConversionTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/google-ads.svg';
    }
    ...
    public function getParameters()
    {
        return array(
            ...
            $this->makeSetting('googleAdsConversionId', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_GoogleAdsConversionTagIdTitle');
                $field->description = Piwik::translate('TagManagerExtended_GoogleAdsConversionTagIdDescription');
            ...
            $this->makeSetting('googleAdsConversionLabel', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_GoogleAdsConversionTagLabelTitle');
                $field->description = Piwik::translate('TagManagerExtended_GoogleAdsConversionTagLabelDescription');
                $field->customFieldComponent = self::FIELD_VARIABLE_COMPONENT;
                $field->validators[] = new NotEmpty();
            }),
