...
class DataLayerSyncTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/sync.svg';
    }

    public function getParameters()
    {
        return array(
            $this->makeSetting('dataLayerName', 'dataLayer', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_DataLayerSyncDataLayerNameTitle');
                $field->description = Piwik::translate('TagManagerExtended_DataLayerSyncDataLayerNameDescription');
