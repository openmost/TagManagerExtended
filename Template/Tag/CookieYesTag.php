...
class CookieYesTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/cookieyes.svg';
    }
    ...
    public function getParameters()
    {
        return array(
            $this->makeSetting('cookiebotWebsiteKey', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_CookieYesTagWebsiteKeyTitle');
                $field->description = Piwik::translate('TagManagerExtended_CookieYesTagWebsiteKeyDescription');
