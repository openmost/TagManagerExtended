...
class GoogleTagTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/google-tag.svg';
    }
    ...
    public function getParameters()
    {
        return array(
            $this->makeSetting('googleTagId', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_GoogleTagTagIdTitle');
                $field->description = Piwik::translate('TagManagerExtended_GoogleTagTagIdDescription');
