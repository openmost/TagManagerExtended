...
class CookiebotTag extends BaseTag
{
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/cookiebot.svg';
    }
    ...
    public function getParameters()
    {
        return array(
            $this->makeSetting('cookiebotId', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_CookiebotTagIdTitle');
                $field->description = Piwik::translate('TagManagerExtended_CookiebotTagIdDescription');
