...
class AffilaeTag extends BaseTag
{
    ...
    {
        return self::CATEGORY_AFFILIATES;
    }
    ...
    public function getIcon()
    {
        ...
        return 'plugins/TagManagerExtended/images/icons/tag/affilae.svg';
    }

    public function getParameters()
    {
        return array(
            $this->makeSetting('programId', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_AffilaeProgramIdTitle');
                $field->description = Piwik::translate('TagManagerExtended_AffilaeProgramIdDescription');
