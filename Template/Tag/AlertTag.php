...
class AlertTag extends BaseTag
{
    ...
    public function getParameters()
    {
        return array(
            $this->makeSetting('content', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_AlertTagContentTitle');
                $field->description = Piwik::translate('TagManagerExtended_AlertTagContentDescription');
