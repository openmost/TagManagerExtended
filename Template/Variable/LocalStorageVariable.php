...
class LocalStorageVariable extends BaseVariable
{
    ...
    public function getParameters()
    {
        return array(
            $this->makeSetting('key', '', FieldConfig::TYPE_STRING, function (FieldConfig $field) {
                $field->title = Piwik::translate('TagManagerExtended_LocalStorageKeyTitle');
                $field->description = Piwik::translate('TagManagerExtended_LocalStorageKeyDescription');
